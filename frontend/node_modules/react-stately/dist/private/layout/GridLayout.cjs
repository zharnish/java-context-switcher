...
class $bd1b03f208c6df73$export$7d2b12578154a735 extends (0, $4b8e6a761bc1571f$exports.Layout) {
    shouldInvalidateLayoutOptions(newOptions, oldOptions) {
        return newOptions.maxColumns !== oldOptions.maxColumns || newOptions.dropIndicatorThickness !== oldOptions.dropIndicatorThickness || newOptions.preserveAspectRatio !== oldOptions.preserveAspectRatio || !(newOptions.minItemSize || $bd1b03f208c6df73$var$DEFAULT_OPTIONS.minItemSize).equals(oldOptions.minItemSize || $bd1b03f208c6df73$var$DEFAULT_OPTIONS.minItemSize) || !(newOptions.maxItemSize || $bd1b03f208c6df73$var$DEFAULT_OPTIONS.maxItemSize).equals(oldOptions.maxItemSize || $bd1b03f208c6df73$var$DEFAULT_OPTIONS.maxItemSize) || !(newOptions.minSpace || $bd1b03f208c6df73$var$DEFAULT_OPTIONS.minSpace).equals(oldOptions.minSpace || $bd1b03f208c6df73$var$DEFAULT_OPTIONS.minSpace) || newOptions.maxHorizontalSpace !== oldOptions.maxHorizontalSpace || newOptions.loaderHeight !== oldOptions.loaderHeight || newOptions.direction !== oldOptions.direction;
    }
    update(invalidationContext) {
        let { minItemSize: minItemSize = $bd1b03f208c6df73$var$DEFAULT_OPTIONS.minItemSize, maxItemSize: maxItemSize = $bd1b03f208c6df73$var$DEFAULT_OPTIONS.maxItemSize, preserveAspectRatio: preserveAspectRatio = $bd1b03f208c6df73$var$DEFAULT_OPTIONS.preserveAspectRatio, minSpace: minSpace = $bd1b03f208c6df73$var$DEFAULT_OPTIONS.minSpace, maxHorizontalSpace: maxHorizontalSpace = $bd1b03f208c6df73$var$DEFAULT_OPTIONS.maxSpace, maxColumns: maxColumns = $bd1b03f208c6df73$var$DEFAULT_OPTIONS.maxColumns, dropIndicatorThickness: dropIndicatorThickness = $bd1b03f208c6df73$var$DEFAULT_OPTIONS.dropIndicatorThickness, loaderHeight: loaderHeight = $bd1b03f208c6df73$var$DEFAULT_OPTIONS.loaderHeight, direction: direction = 'ltr' } = invalidationContext.layoutOptions || {};
    ...
    constructor(...args){
        super(...args), this.gap = $bd1b03f208c6df73$var$DEFAULT_OPTIONS.minSpace, this.dropIndicatorThickness = 2, this.numColumns = 0, this.direction = 'ltr', this.contentSize = new (0, $f9c934dfa703bb0a$exports.Size)(), this.layoutInfos = new Map(), this.margin = 0;
    }
}
