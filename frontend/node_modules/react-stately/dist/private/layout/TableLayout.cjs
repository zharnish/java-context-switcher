...
class $779e19dedce4578d$export$62444c3c724b1b20 extends (0, $d474db7fa4a60716$exports.ListLayout) {
    ...
    buildCollection() {
        ...
        this.contentSize = new (0, $f9c934dfa703bb0a$exports.Size)(width + this.padding * 2, y + this.padding);
        return layoutNodes;
    }
    buildTableHeader() {
        let collection = this.virtualizer.collection;
    ...
    buildRowGroup(y, node) {
        ...
        let layoutInfo = new (0, $6114beb2608093a1$exports.LayoutInfo)('rowgroup', node.key, rect);
        let startY = y;
        let width = 0;
        let children = [];
        let rowHeight = this.getEstimatedRowHeight() + this.gap;
        let childNodes = (0, $c731fb93d14b07fc$exports.getChildNodes)(node, collection);
