...
<step_metadata>
  ...
  <uses>./execute-task.prompt.md</uses>
  <continues>until all tasks complete</continues>
</step_metadata>

<execution_flow>
  LOAD ./execute-task.prompt.md ONCE

  FOR each parent_task assigned in Step 1:
    EXECUTE instructions from ./execute-task.prompt.md with:
      - parent_task_number
...
<instructions>
  ACTION: Load ./execute-task.prompt.md instructions once at start
