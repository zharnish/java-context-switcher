...
<step_metadata>
  <reads>relevant parts of ./standards/best-practices.md</reads>
...
<step_metadata>
  <reads>relevant parts of ./standards/code-style.md</reads>
...
<fallback_test_execution>
  <focused_test_execution>
    ...
    <skip>
      - Full test suite (done later in ./execute-tasks.prompt.md)
  ...
  <instructions>
    ...
    SKIP: Full test suite (that's for ./execute-tasks.prompt.md)
