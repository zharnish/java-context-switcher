...
Install Agent OS into an existing codebase, analyze current product state and progress.  Builds on plan-product.prompt.md
...
<instructions>
  ...
  PREPARE: Information for plan-product.prompt.md execution
</instructions>
...
<step_metadata>
  <uses>./plan-product.prompt.md</uses>
...
<instructions>
  ACTION: Execute plan-product.prompt.md with gathered information
  PROVIDE: All context as structured input
  ALLOW: plan-product.prompt.md to create .agent-os/product/ structure
</instructions>
...
<final_checklist>
  <verify>
    ...
    - [ ] plan-product.prompt.md executed with proper context
